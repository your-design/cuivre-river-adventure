...
Print these at home and toss them in a folder or clipboard. Each opens in your browser;
use your browser's **Print** (or "Save as PDF") to print. Great for quiet time, car
rides, and rainy afternoons.

| Printable | What it is |
|:----------|:-----------|
| 🔎 [Nature Scavenger Hunt](/assets/printables/scavenger-hunt.html) | Find-it list for the trails and campsite |
| 🎲 [Campsite Bingo](/assets/printables/camp-bingo.html) | 5×5 bingo of camp sights & sounds |
...
> has their own. Bring crayons/markers, a clipboard, and a pencil box.
...
- Lead the campfire s'mores, learn a knot (see [Savvy Camper](/guides/savvy-camper#knots-every-camper-should-know))
...
(See the [Swimming](/activities/swimming) page for safety rules.)
...
- **Naturalist program** at the amphitheater ([details](/activities/wildlife))
...
- **Tick check every night** ([how-to](/guides/savvy-camper#safer-tick-control)).
- **Sunscreen + water** on repeat—outdoor kids in July dehydrate and burn fast.

---

[Print the Scavenger Hunt →](/assets/printables/scavenger-hunt.html){: .btn .btn-primary }
[See All Activities →](/activities/){: .btn }
