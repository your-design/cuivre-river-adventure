...
- **Bluegill & sunfish** — the kids' best friend. Plentiful, eager, and easy to catch
  off the bank with a worm and a bobber.
...
- Plus the usual creek cast of **carp, suckers, and small sunfish** in Big Sugar Creek
  and the Cuivre River.
...
- Check current **length/creel limits** on the [MDC site](https://mdc.mo.gov/fishing).
...
5. Bring a **small net**, **pliers** for hooks, and a bucket to show off the catch
   before releasing.
...
- **Bass:** soft plastics, small spinnerbaits, or a topwater at first light along the
  shoreline and weed edges.
- **Catfish:** bottom rig with cut bait or stinkbait in the evening; set a rod and
  enjoy the fire.
- **From a kayak:** drift the shoreline casting—see [Kayaking](/activities/kayaking).
...
[Back: Biking](/activities/biking){: .btn }
[Next: Swimming & the Beach →](/activities/swimming){: .btn .btn-primary }
